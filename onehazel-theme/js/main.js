/**
 * OneHazel — HubSpot Theme JS
 * Theme toggle, mobile menu, billing toggle, sector decorations.
 *
 * NOTE: Nav is now rendered server-side via the HubL partial
 * (partials/nav.html), so renderNav() from the static site is
